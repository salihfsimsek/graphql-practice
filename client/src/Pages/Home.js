...
const Home = () => {
    ...
    return (
        <section className='h-[calc(100vh-3.8rem)]' style={{ backgroundImage: `url(${bgImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <div className='absolute top-1/2 left-1/2 w-[20%] min-w-[150px] translate-x-[-50%] translate-y-[-50%] h-52 bg-[rgba(255,255,255,0.5)] border-2 border-white rounded-lg flex flex-col justify-center items-center gap-y-4'>
